...
function makeArgBox(issue){
  ...
  var box = " <div id = '" + id + "' class='argbox' style='display:none'> <h2>" + title + "</h2> <b> FOR: </b> <div id='" + forId + "'> </div> <div> <i>Source: <span id=" + forSourceId + "></span></i><br><b> AGAINST: </b> <div id='" + againstId + "'> </div> <div><i>Source: <span id=" + againstSourceId  + "></span></i></div></div>";
